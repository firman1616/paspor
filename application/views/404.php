...
<head>
	...
	<link rel="stylesheet" href="<?= base_url('') ?>assets/template/assets/css/atlantis.css">
</head>
<body class="page-not-found">
	<div class="wrapper not-found">
		<h1 class="animated fadeIn">404</h1>
		<div class="desc animated fadeIn"><span>OOPS!</span><br/>Masih dalam masa pengerjaan, Sabarr</div>
		<a href="<?= site_url('Dashboard') ?>" class="btn btn-primary btn-back-home mt-4 animated fadeInUp">
